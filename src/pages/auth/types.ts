...
// Результат успешной регистрации с сессией
export interface RegistrationWithSessionResult {
  registration: RegistrationResponse
  session: SessionResponse
}

// Типы для создания сессии пользователя
...
// Типы для получения списка сессий пользователя
...
// Типы для отзыва всех сессий пользователя
